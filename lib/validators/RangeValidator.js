...
class RangeValidator extends Validator_1.Validator {
    ...
    validate(data) {
        ...
        if (!validator_1.isInt(data))
            throw new ValidatorError_1.ValidatorError(1, this.form.trans(this.invalidMessage));
        if (data < this.min)
            throw new ValidatorError_1.ValidatorError(2, this.form.trans(this.minMessage));
        if (data > this.max)
            throw new ValidatorError_1.ValidatorError(3, this.form.trans(this.maxMessage));
        return data;
    }
}
